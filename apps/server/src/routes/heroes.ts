...
// Never spread the raw request body here: doing so let clients smuggle
// unvalidated fields (e.g. staminaCurrent, xp, victories) into storage, which
// are later read back as authoritative values.
