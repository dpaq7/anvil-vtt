...
import { MapDetailsDialog } from './MapDetailsDialog.js';
...
export function MapGrid({ maps, onSelect, onUpdate, onDelete, selectedId, compact }: MapGridProps) {
  const [editingMap, setEditingMap] = useState<MapAsset | null>(null);
