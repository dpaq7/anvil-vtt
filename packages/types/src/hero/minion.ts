...
import type { Characteristics, Condition, GridPosition, Size, Immunity, Weakness } from './common.js';
import type { Ability, MinionTrait, FixtureTrait } from './abilities.js';
