 ...
 * victories, and a per-round gain of (heroCount + roundNumber). These must stay
 * in step with the live tracker in SessionRoom, which applies the same rule.
 */
...
describe('BattleLogic malice', () => {
  ...
  describe('getMaliceAtRound', () => {
    it('accumulates the round-0 seed plus each round gain', () => {
      // seed floor(2) = 2; round 1 adds 5; round 2 adds 6
  ...
  describe('getMalicePerRound (simplified template base rate)', () => {
