...
export const beastheartSignatureAbilities: Ability[] = [
  ...
  },
  {
    id: 'come-on',
    name: 'Come On!',
    flavorText: 'You launch a flurry of attacks to cover your movement.',
    actionType: 'action',
  ...
  },
  {
    ...
    effect: 'You can spend 1 surge without gaining its benefits. If you do, your companion can use this ability as a free triggered action, targeting a different creature or object with the same power roll, but they do not trigger this effect.',
  },
];
...
export const beastheartThreeFerocityAbilities: Ability[] = [
  {
    id: 'bring-the-thunder',
    name: 'Bring the Thunder',
    flavorText: 'Your companion unleashes a shattering roar, screech, or howl that terrifies your foes - or at least gets their attention.',
    actionType: 'action',
    essenceCost: 3,
    ...
    effect: 'Spend 1 Ferocity: This ability also affects a 2 burst originating from you. An enemy in both areas is only affected once.',
  },
  {
    id: 'herd-the-sheep',
    name: 'Herd the Sheep',
...
export const beastheartFiveFerocityAbilities: Ability[] = [
  {
    id: 'all-of-you-versus-all-of-me',
    ...
    distance: '3 burst',
    target: 'Each enemy in the area',
    effect: 'You can spend a Recovery and gain 3 temporary Stamina for each target. Each target is taunted by you until the end of their next turn. Spend 1 Ferocity: This ability also affects a 3 burst originating from your companion. Targets in this second area are taunted by your companion. An enemy in both areas is taunted only by you.',
  },
  {
    id: 'i-feed-on-your-pain',
...
export const beastheartSevenFerocityAbilities: Ability[] = [
  {
    id: 'death-and-violence',
    name: 'Death and Violence',
    flavorText: 'You leap from your foe\'s corpse.',
    ...
    effect: 'The target dies. You teleport to the target\'s space, shift up to a number of squares equal to your Might score, and can then make a melee free strike. You then make this power roll against each enemy within 5 squares of the target.',
  },
  {
    id: 'head-to-head',
    name: 'Head to Head',
  ...
  },
  {
    id: 'shieldbreaker',
    name: 'Shieldbreaker',
    flavorText: 'You smash through their guard and shatter their armor, leaving them wide open.',
    actionType: 'action',
    essenceCost: 7,
    keywords: ['Beastheart', 'Melee', 'Ranged', 'Strike', 'Weapon'],
    distance: 'Melee 1; Ranged 5',
...
export const beastheartNineFerocityAbilities: Ability[] = [
  {
    id: 'deadshot',
    name: 'Deadshot',
    flavorText: 'You channel your companion\'s feral senses to take the perfect shot.',
    actionType: 'action',
    essenceCost: 9,
    keywords: ['Beastheart', 'Ranged', 'Strike', 'Weapon'],
    distance: 'Ranged 15',
  ...
  {
    id: 'one-two-three-heave',
    name: 'One, Two, Three, Heave',
    flavorText: 'Harnessing your companion\'s strength, you send your foe flying.',
    actionType: 'action',
    essenceCost: 9,
    keywords: ['Beastheart', 'Melee', 'Strike', 'Weapon'],
    distance: 'Melee 1',
...
export const beastheartElevenFerocityAbilities: Ability[] = [
  ...
  },
  {
    ...
    effect: 'Spend 2+ Ferocity: You can spend up to 6 extra Ferocity. For every 2 Ferocity spent, the burst increases by 1, you gain a +2 bonus to the power roll, and you take 5 damage that can\'t be reduced in any way. You can choose how much Ferocity you spend after you make the power roll.',
  },
];
