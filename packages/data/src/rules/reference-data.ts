import type { Ancestry, Culture, Career, Kit, Language, CultureOption } from '@anvil/types';
...
export const languages: Language[] = [
  ...
  { id: 'khelt', name: 'Khelt', relatedTo: 'Bugbears and the fey; Offshoot of Kheltivari' },
...
export const kits: Kit[] = [
  ...
  // ==========================================================================
  {
    ...
    signatureAbility: {
      ...
      keywords: ['Beastheart', 'Magic', 'Ranged', 'Weapon'],
      type: 'Maneuver',
      distance: 'Ranged 5',
      ...
      tier3: '2 + M damage',
      effect:
        "If the target is a creature or object, your companion can teleport to an unoccupied space adjacent to the target, provided your companion is also within range. If the target is an unoccupied space, you or your companion can teleport to the space. Spend 1 Ferocity: The ability's distance increases to ranged 10.",
    },
  },
  {
    id: 'predator',
    ...
    signatureAbility: {
      ...
      keywords: ['Beastheart', 'Melee', 'Weapon'],
      type: 'Maneuver',
      distance: 'Melee 1',
      target: 'One creature',
      powerRoll: 'Might',
      ...
      tier3: '2 + M damage',
      effect:
        "Before using this ability, you can jump in a straight line up to a number of squares equal to your Intuition score. During this jump, you can pass through enemies' spaces without them counting as difficult terrain. You deal extra damage equal to the number of squares you jumped. Spend 1 Ferocity: Your jump doesn't provoke opportunity attacks.",
    },
  },
  {
    id: 'stormcrow',
    ...
    signatureAbility: {
      ...
      target: 'Each enemy in the area',
      powerRoll: 'Might',
      tier1: 'M cold, fire, lightning, or sonic damage (your choice)',
      tier2: 'M cold, fire, lightning, or sonic damage (your choice)',
      tier3: 'M cold, fire, lightning, or sonic damage (your choice)',
      effect: 'Spend 1 Ferocity: The distance becomes 3 cube within 1.',
    },
  },
  {
    id: 'war-beast',
    ...
    signatureAbility: {
      ...
      keywords: ['Beastheart', 'Charge', 'Melee', 'Weapon'],
      type: 'Maneuver',
      distance: 'Melee 1',
      target: 'One creature',
      powerRoll: 'Might',
      tier1: '2 + M damage; M < MEDIUM, prone',
      tier2: '2 + M damage; M < MEDIUM, prone',
      tier3: '2 + M damage; M < MEDIUM, prone',
      effect:
        "You can move up to three squares after the strike. During this move, a prone enemy's space doesn't count as difficult terrain, and the first time you enter each prone enemy's space you deal damage equal to your Might score. Spend 1 Ferocity: If the target is M < STRONG, they are prone.",
    },
  },
];
